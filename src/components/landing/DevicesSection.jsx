        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {devices.map((d, i) => (
            ...
            >
              <Link
                to={`/devices/${d.id}`}
                className={`group flex flex-col h-full border rounded-2xl p-6 hover:shadow-lg hover:border-primary/40 transition-all duration-300 cursor-pointer ${d.color}`}
              >
